...
public class TestXfireWebService {
	...
	public static String callService(String wsurl, String method, Object[] params){
		Client client = TestXfireWebService.getWebServiceConnect(wsurl);
		Object[] results = null;
		try {
...
//				            "\"动力楼\",\"动力楼1\",\"生产楼\",\"生产楼1\"]},\"授权权限\" : \"11000\",\"附加权限\" : \"10000\"}";
		System.out.println(TestXfireWebService.callService("http://localhost:8080/dcv_jupiter1/services/DataStream?wsdl", "addUser", params));
	}
